<template>
	<view class="page">
		...
		>
			...
			<view class="meta">
				<text class="meta-tag">{{ categoryLabel(PASSENGER_CATEGORIES, item.category) }}</text>
...
<script setup>
	...
	const goCreate = () => {
		uni.navigateTo({ url: '/pages/ticket/create/index' })
	}

	const goDetail = (id) => {
		uni.navigateTo({ url: `/pages/ticket/detail/index?ticketId=${id}` })
	}
