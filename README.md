...
- 分布式方案：Redisson 分布式锁（防并发重复派单）、Seata 全局事务
- 高可用保护：Sentinel接口限流、熔断、监控
...
| 功能模块    | 效果展示                                       |
| ----------- | ---------------------------------------------- |
| seata控制台 | <img src="./assets/seata.png" width="1000">    |
| sentinel    | <img src="./assets/sentinel.png" width="1000"> |
...
- Seata 全局事务保证支付、订单完成等关键流程数据一致性
- Sentinel 限流防护，保障接口高并发稳定性

**容器化部署**

- Docker + Docker Compose 一键部署、服务编排、日志管理
