...
public class AmapConfigConstants {
    ...
    //查询终端信息
    public static final String TERMINAL_QUERY="https://tsapi.amap.com/v1/track/terminal/list";
    //删除终端
    public static final String TERMINAL_DELETE="https://tsapi.amap.com/v1/track/terminal/delete";

    //查询终端（最后的位置信息）
    public static final String TERMINAL_QUERY_LAST="https://tsapi.amap.com/v1/track/terminal/search";
    //创建轨迹
    public static final String TRACE_ADD="https://tsapi.amap.com/v1/track/trace/add";
    ...
    //修改终端
    public static final String TERMINAL_UPDATE="https://tsapi.amap.com/v1/track/terminal/update";
