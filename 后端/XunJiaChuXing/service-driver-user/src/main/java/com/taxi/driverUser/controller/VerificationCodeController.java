...
public class VerificationCodeController {
    ...
    public Result verificationCode(@Validated(ValidationGroups.DriverSend.class) @RequestBody VerificationCodeDTO verificationCodeDTO){
    ...
    public Result checkVerificationCode(@Validated(ValidationGroups.DriverCheck.class) @RequestBody VerificationCodeDTO verificationCodeDTO){
        String driverPhone = verificationCodeDTO.getDriverPhone();
