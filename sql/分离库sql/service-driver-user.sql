...
INSERT INTO `car` VALUES (1,'370100','京A2541','1',5,'比亚迪','唐A','1','王五','2','AB55487C','LSDAGDSVSE','2023-11-30','5','1500','北京市交通运输局','北京市','2023-11-15','2037-11-20','2023-11-07','1','2025-11-14','1','55487','ss','ss','2023-11-06','2023-11-22',1,'110000$1',0,'1866119768','20',NULL,'2026-04-21 20:36:54','2026-04-21 20:36:54'),(2,'370100','鲁A83fe','1',5,'雪佛兰','雪A','1','陈加','1','v8','23cr3e','2026-03-18','1','35600','国家税务局','北京市','2026-03-10','2027-03-18',NULL,'0','2026-03-31','1','238C832NCR32R','GGP','A186','2026-03-16',NULL,1,NULL,0,'1879222808','120','','2026-03-26 14:14:03','2026-03-26 14:14:03');
/*!40000 ALTER TABLE `car` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dict_car_class`
--

DROP TABLE IF EXISTS `dict_car_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dict_car_class` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `class_code` varchar(16) NOT NULL COMMENT '类型代码',
  `class_name` varchar(32) NOT NULL COMMENT '类型名',
  `sort_order` int DEFAULT '0' COMMENT '排序字段',
  `state` tinyint(1) DEFAULT '0' COMMENT '启用状态',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_class_code` (`class_code`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆类型字典';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dict_car_class`
--

LOCK TABLES `dict_car_class` WRITE;
/*!40000 ALTER TABLE `dict_car_class` DISABLE KEYS */;
INSERT INTO `dict_car_class` VALUES (1,'1','轿车',1,0,'2026-08-21 14:42:38','2026-08-21 14:42:38'),(2,'2','SUV',2,0,'2026-08-21 14:42:38','2026-08-21 14:42:38'),(3,'3','MPV',3,0,'2026-08-21 14:42:38','2026-08-21 14:42:38'),(4,'4','面包车',4,0,'2026-08-21 14:42:38','2026-08-21 14:42:38'),(5,'9','其他',9,0,'2026-08-21 14:42:38','2026-08-21 14:42:38');
/*!40000 ALTER TABLE `dict_car_class` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `driver_car_binding_relationship` (
  ...
  `vehicle_no` varchar(255) DEFAULT NULL COMMENT '车牌号',
  `bind_state` int DEFAULT NULL COMMENT '绑定状态（1绑定2解绑）',
...
INSERT INTO `driver_car_binding_relationship` VALUES (1,1,1,'京A2541',2,'2023-11-26 18:24:18',NULL),(5,2,2,'鲁A83fe',2,'2026-03-26 14:14:32',NULL),(6,2,2,'鲁A83fe',2,'2026-03-26 15:02:54',NULL),(7,2,2,'鲁A83fe',2,'2026-03-26 17:03:06',NULL),(8,1,2,'鲁A83fe',2,'2026-08-26 14:55:03',NULL),(9,1,1,'京A2541',1,'2026-08-26 15:00:30',NULL),(10,2,2,'鲁A83fe',1,'2026-08-26 15:07:32',NULL);
...
CREATE TABLE `driver_user` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `address` char(6) DEFAULT NULL COMMENT '司机运营地行政区划代码(出车下单时比对)',
...
CREATE TABLE `driver_user_work_status` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `driver_id` bigint DEFAULT NULL COMMENT '司机ID',
  `work_status` int DEFAULT NULL COMMENT '工作状态(1工作2休息)',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
...
INSERT INTO `driver_user_work_status` VALUES (1,1,1,'2023-11-21 15:32:34','2026-09-06 11:18:11'),(8,2,0,'2026-03-26 08:29:19','2026-08-26 15:04:36');
...
-- Dump completed on 2026-09-06 13:27:38
